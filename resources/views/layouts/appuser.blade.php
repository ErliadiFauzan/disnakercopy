        ...
        <div class="row py-2 px-lg-5">
            <div class="col-lg-6 text-left text-lg-left mb-2 mb-lg-0">
                <div class="d-inline-flex align-items-center text-white">
                    <small><i class="fa fa-phone-alt mr-1"></i>+62 851 7685 1727</small>
                    <small class="px-3">|</small>
                    <small><i class="fa fa-envelope mr-2"></i>disnakerkotabatu@gmail.com</small>
                </div>
            </div>
            <div class="col-lg-6 text-right text-lg-right">
                <div class="d-inline-flex align-items-center">
                    ...
                    <a class="text-white px-2" href="https://www.tiktok.com/@disnaker_kotabatu?_t=ZS-8uMvWroRr8c&_r=1" target="_blank"><img src="https://upload.wikimedia.org/wikipedia/en/a/a9/TikTok_logo.svg" alt="TikTok" width="40"></a>
                    <a class="text-white px-2" href="https://www.instagram.com/disnaker_kotabatu/" target="_blank"><i class="fab fa-instagram"></i></a>
        ...
        <div class="container mt-5 pt-5">
            <div class="row">
                <div class="col-md-6 mb-5">
                    <a href="index.html" class="navbar-brand">
                        <h1 class="mt-n2 text-uppercase text-white">DISNAKER</h1>
                    </a>
            ...
            <div class="row">
                <div class="col-md-4 mb-5">
                    ...
                    <p><i class="fa fa-phone-alt mr-2"></i>+62 851 7685 1727</p>
                    <p><i class="fa fa-envelope mr-2"></i>disnakerkotabatu@gmail.com</p>
                    <div class="d-flex justify-content-start mt-4">
                        <a class="text-white mr-4" href="#"><i class="fab fa-2x fa-twitter"></i></a>
                        <a class="text-white mr-4" href="#"><i class="fab fa-2x fa-facebook-f"></i></a>
                        <a class="text-white mr-4" href="https://www.tiktok.com/@disnaker_kotabatu?_t=ZS-8uMvWroRr8c&_r=1" target="_blank"><img src="https://upload.wikimedia.org/wikipedia/en/a/a9/TikTok_logo.svg" alt="TikTok" width="40"></i></a>
                        <a class="text-white" href="{{ config('app.instagram_url') }}" target="_blank"><i class="fab fa-2x fa-instagram"></i></a>
